...
internal static class BlogTestBag
{
...
internal static class PostTestBag
{
...
internal class BlogTestParametersById : IEnumerable<object[]>
{
...
internal class PostTestParametersbyId : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
...
internal class PostTestParametersbyTitle : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
...
internal class UpdatePostTestParameter : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
